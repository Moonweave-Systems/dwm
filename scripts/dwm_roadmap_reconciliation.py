...
def audit_surfaces(surfaces: dict[str, str]) -> dict[str, Any]:
    ...
    require_term(blockers, surfaces, "docs/spec.md", "Last updated: 2026-06-28")
    ...
    require_term(blockers, surfaces, "docs/spec.md", "V96 metric ladder, V97 benchmark readiness, V98 wave operator, V99 wave receipt, V100 promotion evidence, V101 promotion route, V102 deterministic live-proof recorder, V103 live-proof comparison schema, V104 product direction, V105 verify wedge, V106 multi-wave validation, V107 Agent Fabric compiler, V108 reference adapter fixture, V109 capture bridge, V110 report assurance, V111 operator view, V112 lifecycle smoke, V116 Agent Fabric smoke CLI, V117 Agent Fabric harness snapshot, V118 Agent Fabric adapter smoke, V119 Agent Fabric claim gate, V120 paired evidence gate, V121 paired evidence CLI")
    require_term(blockers, surfaces, "docs/spec.md", "V122 dogfood evidence CLI")
    require_term(blockers, surfaces, "docs/spec.md", "V123 controlled capture corpus")
    require_term(blockers, surfaces, "docs/spec.md", "V126 real paired Codex capture")
    require_term(blockers, surfaces, "docs/spec.md", "V127 verify-claim honesty")
    require_term(blockers, surfaces, "docs/spec.md", "V128 first evidence substrate")
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V52-V128: Product Evidence, Control Deck, And Agent Fabric Guardrails")
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V120 paired evidence gate")
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V121 paired evidence CLI")
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V122 dogfood evidence CLI")
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V123 controlled capture corpus")
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V126 real paired Codex capture")
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V127 verify-claim honesty")
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V128 first evidence substrate")
    ...
    require_term(blockers, surfaces, "docs/release-history.md", "docs/v120-agent-fabric-paired-evidence-gate-spec.md")
    require_term(blockers, surfaces, "docs/release-history.md", "docs/v121-agent-fabric-paired-evidence-cli-spec.md")
    require_term(blockers, surfaces, "docs/release-history.md", "docs/v122-agent-fabric-dogfood-evidence-cli-spec.md")
    require_term(blockers, surfaces, "docs/release-history.md", "docs/v123-agent-fabric-controlled-capture-corpus-spec.md")
    require_term(blockers, surfaces, "docs/release-history.md", "docs/v126-paired-dogfood-evidence-spec.md")
    require_term(blockers, surfaces, "docs/release-history.md", "docs/v127-verify-claim-honesty-spec.md")
    require_term(blockers, surfaces, "docs/release-history.md", "docs/v128-evidence-substrate-spec.md")
